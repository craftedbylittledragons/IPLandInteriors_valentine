...
Config.door_hash_v2 = {
--[entity] ={entity,hash_code,obj_name,-314.757, 815.003, 119.181},  
}  
...
Config.EnterRoom = {x = -314.757, y= 815.003, z=119.181,  h = 000.00 }  -- upstairs left - room exists and is furnished 

Config.TeleportExit_On = true 
Config.ExitRoom = {x = -314.757, y= 815.003, z=119.181, h = 000.00 } --- needs coords
