...
-----------------------------------------------------
RegisterCommand("takemeto_SaloonRoomA", function(source, args)    
    if args ~= nil then   
        local data =  source 
        local ped = PlayerPedId() 
        local coords = GetEntityCoords(ped)        
        if Config.TeleportME == true then 
            TriggerEvent( "SaloonRoomA:scottybeammeup", Config.x, Config.y, Config.z )
        else 
...
RegisterNetEvent('SaloonRoomA:scottybeammeup')
AddEventHandler('SaloonRoomA:scottybeammeup', function(x,y,z)  
