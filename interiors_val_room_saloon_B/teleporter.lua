...
-----------------------------------------------------
RegisterCommand("takemeto_SaloonRoomB", function(source, args)    
    if args ~= nil then   
        local data =  source 
        local ped = PlayerPedId() 
        local coords = GetEntityCoords(ped)        
        if Config.TeleportME == true then 
            TriggerEvent( "SaloonRoomB:scottybeammeup", Config.x, Config.y, Config.z )
        else 
...
RegisterNetEvent('SaloonRoomB:scottybeammeup')
AddEventHandler('SaloonRoomB:scottybeammeup', function(x,y,z)  
