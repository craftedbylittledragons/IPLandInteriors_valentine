...
-----------------------------------------------------
RegisterCommand("takemeto_ValTrainStn", function(source, args)    
    if args ~= nil then   
        local data =  source 
        local ped = PlayerPedId() 
        local coords = GetEntityCoords(ped)        
        if Config.TeleportME == true then 
            TriggerEvent( "ValTrainStn:scottybeammeup", Config.x, Config.y, Config.z )
        else 
...
RegisterNetEvent('ValTrainStn:scottybeammeup')
AddEventHandler('ValTrainStn:scottybeammeup', function(x,y,z)  
