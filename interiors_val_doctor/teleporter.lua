...
-----------------------------------------------------
RegisterCommand("takemeto_ValDoctor", function(source, args)    
    if args ~= nil then   
        local data =  source 
        local ped = PlayerPedId() 
        local coords = GetEntityCoords(ped)        
        if Config.TeleportME == true then 
            TriggerEvent( "ValDoctor:scottybeammeup", Config.x, Config.y, Config.z )
        else 
...
RegisterNetEvent('ValDoctor:scottybeammeup')
AddEventHandler('ValDoctor:scottybeammeup', function(x,y,z)  
