...
-----------------------------------------------------
RegisterCommand("takemeto_ValEncampment", function(source, args)    
    if args ~= nil then   
        local data =  source 
        local ped = PlayerPedId() 
        local coords = GetEntityCoords(ped)        
        if Config.TeleportME == true then 
            TriggerEvent( "ValEncampment:scottybeammeup", Config.x, Config.y, Config.z )
        else 
...
RegisterNetEvent('ValEncampment:scottybeammeup')
AddEventHandler('ValEncampment:scottybeammeup', function(x,y,z)  
