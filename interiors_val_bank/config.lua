...
Config.ymaps = {
    {filename ="val_02__interior_val_bank_int_main_milo_.ymap", name ="val_02__interior_val_bank_int_main_milo_", parent_name="Interior", hash="", trigger=true, description=""},
